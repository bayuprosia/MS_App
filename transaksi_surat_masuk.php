                                ...
                                <div class="col m12">
                                    <div class="card green lighten-5">
                                        <div class="card-content notif">
                                            <span class="card-title green-text"><i class="material-icons md-36">done</i> ' . htmlspecialchars($succAdd) . '</span>
                                        </div>
                                    </div>
                                </div>
                            </div>';
            ...
            if (isset($_SESSION['succEdit'])) {
                ...
                echo '<div id="alert-message" class="row">
                                <div class="col m12">
                                    <div class="card green lighten-5">
                                        <div class="card-content notif">
                                            <span class="card-title green-text"><i class="material-icons md-36">done</i> ' . htmlspecialchars($succEdit) . '</span>
                                        </div>
                                    </div>
                                </div>
                            </div>';
            ...
            if (isset($_SESSION['succDel'])) {
                ...
                echo '<div id="alert-message" class="row">
                                <div class="col m12">
                                    <div class="card green lighten-5">
                                        <div class="card-content notif">
                                            <span class="card-title green-text"><i class="material-icons md-36">done</i> ' . htmlspecialchars($succDel) . '</span>
                                        </div>
                                    </div>
                                </div>
                            </div>';
                    ...
                    echo '
                        <div class="col s12" style="margin-top: -18px;">
                            <div class="card blue lighten-5">
                                ...
                                <p class="description">Hasil pencarian untuk kata kunci <strong>"' . htmlspecialchars(stripslashes($cari)) . '"</strong><span class="right"><a href="?page=tsm"><i class="material-icons md-36" style="color: #333;">clear</i></a></span></p>
                                </div>
                            </div>
                        </div>
